...
const Message = ({
  ...
  console.log("sent", new Date(message.sent_at).toDateString());

  // console.log(moment(today.toDateString()).format(FORMAT_DATE));
  // console.log(moment(message.sent_at).format(FORMAT_DATE));
